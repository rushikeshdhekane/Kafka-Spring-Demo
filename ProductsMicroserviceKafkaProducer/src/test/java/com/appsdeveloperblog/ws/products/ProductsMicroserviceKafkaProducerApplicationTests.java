...
class ProductsMicroserviceKafkaProducerApplicationTests {
	...
	@Test
	void testCreateProduct_whenGivenValidProductDetails_successfullSendkafkaMessage() throws Exception {
	
		//Arrange
		String title ="iphone_11";
		...
		//Act
		productService.createProductSynchronus(createProductRestModel);
