...
public class ProductCreatedEventHandler {
	...
	@KafkaHandler
	@Transactional
	public void handle(ProductCreatedEvent productCreatedEvent, @Header("messageId") String messageId,
			@Header(KafkaHeaders.RECEIVED_KEY) String messageKey) 
	{
		LOGGER.info("Received a new event: " + productCreatedEvent.getTitle() + " with productId: "
				+ productCreatedEvent.getProductId());
		
		LOGGER.info("Message id received at consumer side : "+messageId);
